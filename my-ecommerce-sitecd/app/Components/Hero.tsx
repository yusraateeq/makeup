...
//   return (
//     <section
//       className="relative h-[650px]  flex items-center justify-center text-center bg-cover bg-center px-8 sm:px-16 lg:px-32 pt-20"
//       style={{
...
//         <p className='border-2 py-2 mx-96 rounded-full mb-4 mt-20'>New winter collection 2025</p>
//         <h1 className="text-6xl font-bold mb-6">Transform Your Look with Our Makeup Collection</h1>
...
//         <a
//           href="#shop"
//           className="mt-6 inline-block py-3 px-10 bg-pink-600 text-white font-semibold text-lg rounded-lg shadow-lg transition duration-300 transform hover:scale-105 hover:bg-pink-700 relative overflow-hidden animate-pulse"
//         >
//           {/* Icon inside the button */}
//          <Link href="/Shop"><span className="mr-2">Shop Now</span></Link> 
//           <Image
//             src={cartIcon}
//             alt="Cart Icon"
//             width={20}
