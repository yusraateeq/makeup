...
// import image1 from '../assets/shadow.jpg'; // Adjust the path if needed
...
//   price: number;
//   image: any;
//   category: string; // Added category to product
// }
...
//       (categoryFilter ? product.category === categoryFilter : true) && // Filter by category
//       product.price >= minPrice && product.price <= maxPrice // Filter by price range
//     );
//   });

//   const categories = ['Blush', 'Eye shadow', 'Lipstick']; // Example categories
...
//       <Shophero/>
//       <main className="flex flex-row min-h-screen mt-20">
...
//                   className={`cursor-pointer ${categoryFilter === category ? 'text-pink-600' : ''}`}
//                 >
//                   {category}
//                 </li>
//               ))}
...
//           <h1 className="text-6xl text-pink-600 font-bold mb-6">Shop Now</h1>
//           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
//             {filteredProducts.length > 0 ? (
//               filteredProducts.map((product) => (
//                 <div key={product.id} className="border p-4 w-72 rounded-lg hover:shadow-lg transition-all duration-300">
//                   <Image
//                     src={product.image}
//                     alt={product.name}
//                     className="w-full h-72 mb-2 rounded-lg"
//                     width={200}
//                     height={200}
//                   />
